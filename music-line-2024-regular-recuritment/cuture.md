...
50 +-5초 만큼
면접관은 서류검토하는 시간 
첫인상 파악하기 위한 시간적 여유 -> 다음 질문이 결판이 남 

1. 구조를 만든다
2. 필살기 2개 = 유사경험,성공경험,인사이트 -> 수치화  
3. 지원동기 

어디어디에 지원한 누구입니다 - 1줄
필살기1 HOW + RESULT - 2줄~3줄
필살기2 
지원동기+입사포부 2줄 

자기소개서 , 경력기술서, 1차면접,임원면접 -> 동일한 자기소개를 던져라 - 필살기가 자기소개서와 경력소개서 모두 있어야한다 

유사경험 쓰기 

```text
안녕하세요 저는 라인 백엔드 엔지니어로 지원한 김민상 입니다.

저는 대학교 졸업작품에서 85개 팀중 웹부문 2위로 우수상을 수상한 경험이 있습니다.

졸업작품을 시작할 때 팀원들과 프로젝트의 배포와 운영을 하자는 목표를 세웠고, 
이 목표를 달성하기 위해 컨플루언스 구축과 제가 그동안 배웠던 기술적 지식 그리고 앞으로 새롭게 쌓은 지식들의 글을 공유했습니다.
...
저는 기록을 통한 학습과 팀원 간 지식 공유를 매우 중요하게 생각합니다. 이를 통해 빠르게 변화하는 환경에서도 팀이 함께 성장할 수 있도록 기여할 수 있습니다
